...
/*xwk begin*/
function _3dx(pre,data,form){
for(var name in data){
var val=data[name];
if(typeof(val)=="object"){
name = pre+name;
if(val!=null && val!="" && typeof(val['timezoneOffset'])!="undefined"){
var datevalue = $.fn.datebox.defaults.formatter(new Date(val.time));
if(!_512(pre+name,datevalue)){
if(!_513(pre+name,datevalue)){
$('#'+pre+name).datebox('setValue',datevalue);
}}}
else{
_3dx(name+'.',val,form);
}}
else{
if(!_512(pre+name,val)){
if(!_513(pre+name,val)){
form.find("input[name=\""+pre+name+"\"]").val(val);
form.find("textarea[name=\""+pre+name+"\"]").val(val);
form.find("select[name=\""+pre+name+"\"]").val(val);
}}}}
}
/*xwk end*/
...
/*xwk_start*/
var dot = _793.split('.');
var _794 = _791;//var _794=_791[_793];
for(var xx=0;xx<dot.length;xx++){_794=(_794[dot[xx]]!=null)?_794[dot[xx]]:"";}
/*xwk_end*/
...
/*xwk_start*/
var dot = _8f1.split('.');
var val = row;//val=row[_8f1];
for(var xx=0;xx<dot.length;xx++){val=(val[dot[xx]]!=null)?val[dot[xx]]:"";}
/*xwk_end*/
}
