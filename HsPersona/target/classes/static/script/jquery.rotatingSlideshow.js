...
(function ($) {
  ...
  rotatingSlideshow.prototype = {
    ...
    _update: function(currentDeg, currentPos, animSpeed){
	  ...
	  $('#topDiv').css("background-color",bgcolor[pos-1]);
	  $('#caseTitleDiv').css("color",bgcolor[pos-1]);
	  $('#caseSubTitleDiv').css("color",bgcolor[pos-1]);
	  $('.case_cell_text').css("background",bgcolor[pos-1]);
    },
    ...
    _setAutoRotation: function(){
      ...
      deg += 90;
      // call func
	  $('#topDiv').css("background-color",bgcolor[(currentPos-1)%4]);
	  $('#caseTitleDiv').css("color",bgcolor[(currentPos-1)%4]);
	  $('#caseSubTitleDiv').css("color",bgcolor[(currentPos-1)%4]);
	  $('.case_cell_text').css("background",bgcolor[(currentPos-1)%4]);
  ...
  var timer;
  var btnClick = false;
  var bgcolor = ["#471B97","#00A2CA","#2C9030","#0176D3"];
